  ...
  Popular: [
    {
      ...
      title: 'Executive MBA - Strategy, Leadership & Business Excellence',
      category: 'MBA',
      price: '₹49,999',
      rating: 4.9,
    },
    {
      image: '/images/mba.jpg',
      title: 'Advanced Product Management - UX, Agile & Growth Strategies',
    ...
    {
      image: '/images/mba.jpg',
      title: 'Executive Certificate in Data Analytics and Business Intelligence',
...
const ExecutiveEducationSection = () => {
  const [activeTab, setActiveTab] = useState('Popular')

  return (
    <Wrapper>
      <Heading>
        <span>Scale up your career with</span>
      ...
      <ExploreButton>Explore all Executive Education Courses</ExploreButton>
    </Wrapper>
  )
}

export default ExecutiveEducationSection
